    ...
    <div>
      <div className=" space-y-2 p-4 rounded-[10px] shadow-md w-full h-[458px] bg-white">
        <div  className="flex item-center gap-1 ">
          ...
          <h1 className="text-[16px]">Grafik Tren Penjualan Stok Mingguan</h1>
        </div>
        <p className="text-[12px] text-gray-500">
          Menampilkan tren Penjualan stok beras setiap Mingguan dalam satu Bulan
          terakhir,berdasarkan Kategori berat beras{" "}
        </p>
        <ChartGaris/>
      </div>
    </div>
